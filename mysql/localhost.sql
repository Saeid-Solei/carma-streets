...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='This table lists the plugins loaded and available to run on the IVP platform.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-06-16  9:18:05
